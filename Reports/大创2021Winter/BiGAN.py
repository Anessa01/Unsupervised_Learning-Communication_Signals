...
from    tensorflow.keras.layers import Dense,Dropout,LeakyReLU,BatchNormalization,Reshape,Flatten
import  numpy as np
import  matplotlib
...
class BIGAN():
    ...
    def build_discriminator(self):
        ...
        z = Input(shape=(self.latent_dim,))
        img = Input(shape=self.img_shape)
        img_=keras.layers.Flatten()(img)
        print(img_,z)
        d_in =  tf.keras.layers.concatenate([z, img_])
